...
static const std::map<std::string, VX2750Pha::FwType> stringToFwType = {
    {"DPP_PHA", VX2750Pha::DPP_PHA},   {"DPP_ZLE", VX2750Pha::DPP_ZLE},
    {"DPP_PSD", VX2750Pha::DPP_PSD},   {"DPP_DAW", VX2750Pha::DPP_DAW},
    {"DPP_OPEN", VX2750Pha::DPP_OPEN}, {"Scope", VX2750Pha::Scope}};

static const std::map<std::string, VX2750Pha::FormFactor> stringToFormFactor = {
    {"0", VX2750Pha::VME}, {"1", VX2750Pha::VME64X}, {"2", VX2750Pha::DT}};

const std::map<std::string, VX2750Pha::ClockSource>
    VX2750Pha::stringToClockSource = {{"Internal", VX2750Pha::Internal},
...
const std::map<std::string, VX2750Pha::StartSource>
    VX2750Pha::stringToStartSource = {
...
const std::map<std::string, VX2750Pha::GlobalTriggerSource>
    VX2750Pha::stringToGlobalTriggerSource = {
...
static const std::map<VX2750Pha::GlobalTriggerSource, std::string>
    globalTriggerSourceToString = {
...
const std::map<std::string, VX2750Pha::WaveTriggerSource>
    VX2750Pha::stringToWaveTrigger = {
...
static const std::map<VX2750Pha::WaveTriggerSource, std::string>
    waveTriggerToString = {
...
const std::map<std::string, VX2750Pha::EventTriggerSource>
    VX2750Pha::stringToEventTrigger = {
...
static const std::map<VX2750Pha::EventTriggerSource, std::string>
    eventTriggerToString = {
...
static const std::map<std::string, VX2750Pha::TraceRecordMode>
    stringToTraceRecord = {{"Always", VX2750Pha::Always},
                           {"OnRequest", VX2750Pha::OnRequest}};
static const std::map<VX2750Pha::TraceRecordMode, std::string>
    traceRecordToString = {{VX2750Pha::Always, "Always"},
...
const std::map<std::string, VX2750Pha::VetoPolarity>
    VX2750Pha::stringToVetoPolarity = {{"ActiveHigh", VX2750Pha::ActiveHigh},
                                       {"ActiveLow", VX2750Pha::ActiveLow}};
static const std::map<VX2750Pha::VetoPolarity, std::string>
    vetoPolarityToString = {{VX2750Pha::ActiveHigh, "ActiveHigh"},
                            {VX2750Pha::ActiveLow, "ActiveLow"}};

const std::map<std::string, VX2750Pha::ChannelVetoSource>
    VX2750Pha::stringToChannelVeto = {
...
static const std::map<VX2750Pha::ChannelVetoSource, std::string>
    channelVetoToString = {{VX2750Pha::BoardVeto, "BoardVeto"},
...
const std::map<std::string, VX2750Pha::WaveDataSource>
    VX2750Pha::stringToWaveDataSource = {
...
static const std::map<VX2750Pha::WaveDataSource, std::string>
    waveDataSourceToString = {{VX2750Pha::ADC_DATA, "ADC_DATA"},
...
const std::map<std::string, VX2750Pha::WaveResolution>
    VX2750Pha::stringToWaveResolution = {{"Res8", VX2750Pha::Res8},
                                         {"Res16", VX2750Pha::Res16},
                                         {"Res32", VX2750Pha::Res32},
                                         {"Res64", VX2750Pha::Res64}};
static const std::map<VX2750Pha::WaveResolution, std::string>
    waveResolutionToString = {{
                                  VX2750Pha::Res8,
                                  "Res8",
                              },
...
const std::map<std::string, VX2750Pha::AnalogProbe>
    VX2750Pha::stringToAnalogProbe = {
...
const std::map<std::string, VX2750Pha::DigitalProbe>
    VX2750Pha::stringToDigitalProbe = {
...
static const std::map<VX2750Pha::DigitalProbe, std::string>
    digitalProbeToString = {
...
static const std::map<std::string, VX2750Pha::IOLevel> stringToIOLevel = {
    {"TTL", VX2750Pha::TTL}, {"NIM", VX2750Pha::NIM}};
static const std::map<VX2750Pha::IOLevel, std::string> ioLevelToString = {
    {VX2750Pha::NIM, "NIM"}, {VX2750Pha::TTL, "TTL"}};

const std::map<std::string, VX2750Pha::IndividualTriggerLogic>
    VX2750Pha::stringToIndividualTriggerLogic = {
        {"OR", VX2750Pha::ITL_OR},
        {"AND", VX2750Pha::ITL_AND},
        {"Majority", VX2750Pha::Majority}};
static const std::map<VX2750Pha::IndividualTriggerLogic, std::string>
    individualTriggerLogicToString = {{VX2750Pha::ITL_OR, "OR"},
                                      {VX2750Pha::ITL_AND, "AND"},
                                      {VX2750Pha::Majority, "Majority"}};

const std::map<std::string, VX2750Pha::PairTriggerLogic>
    VX2750Pha::stringToPairLogic = {{"AND", VX2750Pha::PTL_AND},
                                    {"OR", VX2750Pha::PTL_OR},
                                    {"NONE", VX2750Pha::NONE}};
static const std::map<VX2750Pha::PairTriggerLogic, std::string>
    pairLogicToString = {{VX2750Pha::PTL_AND, "AND"},
                         {VX2750Pha::PTL_OR, "OR"},
                         {VX2750Pha::NONE, "NONE"}};

const std::map<std::string, VX2750Pha::ITLConnect>
    VX2750Pha::stringToITLConnect = {{"Disabled", VX2750Pha::ITL_Disabled},
...
static const std::map<std::string, VX2750Pha::LVDSDirection>
    stringToLVDSDirection = {{"Input", VX2750Pha::Input},
                             {"Output", VX2750Pha::Output}};
static const std::map<VX2750Pha::LVDSDirection, std::string>
    LVDSDirectionToString = {{VX2750Pha::Input, "Input"},
                             {VX2750Pha::Output, "Output"}};

const std::map<std::string, VX2750Pha::DACOutputMode>
    VX2750Pha::stringToDACOutMode = {{"Static", VX2750Pha::Static},
...
static const std::map<VX2750Pha::DACOutputMode, std::string>
    DACOutModeToString = {{VX2750Pha::Static, "Static"},
...
static const std::map<std::string, VX2750Pha::Polarity> stringToPolarity = {
    {"Positive", VX2750Pha::Positive}, {"Negative", VX2750Pha::Negative}};
static const std::map<VX2750Pha::Polarity, std::string> polarityToString = {
    {VX2750Pha::Positive, "Positive"}, {VX2750Pha::Negative, "Negative"}};

const std::map<std::string, VX2750Pha::EventSelection>
    VX2750Pha::stringToEventSelection = {{"All", VX2750Pha::All},
                                         {"Pileup", VX2750Pha::Pileup},
                                         {"EnergySkim", VX2750Pha::EnergySkim}};
static const std::map<VX2750Pha::EventSelection, std::string>
    eventSelectionToString = {{VX2750Pha::All, "All"},
                              {VX2750Pha::Pileup, "Pileup"},
                              {VX2750Pha::EnergySkim, "EnergySkim"}};

const std::map<std::string, VX2750Pha::CoincidenceMask>
    VX2750Pha::stringToCoincidenceMask = {
...
static const std::map<VX2750Pha::CoincidenceMask, std::string>
    coincidenceMaskToString = {
...
static const std::map<std::string, VX2750Pha::EnergyPeakingAverage>
    stringToPeakingAverage = {{"OneShot", VX2750Pha::Average1},
                              {"LowAVG", VX2750Pha::Average4},
                              {"MediumAVG", VX2750Pha::EPeakAvg_Average16},
                              {"HighAVG", VX2750Pha::EPeakAvg_Average64}};
static const std::map<VX2750Pha::EnergyPeakingAverage, std::string>
    peakingAverageToString = {{VX2750Pha::Average1, "OneShot"},
                              {VX2750Pha::Average4, "LowAVG"},
                              {VX2750Pha::EPeakAvg_Average16, "MediumAVG"},
                              {VX2750Pha::EPeakAvg_Average64, "HighAVG"}};

static const std::map<std::string, VX2750Pha::EnergyFilterBaselineAverage>
    stringToBLAverage = {{"Fixed", VX2750Pha::Fixed},
...
static const std::map<VX2750Pha::EnergyFilterBaselineAverage, std::string>
    BLAverageToString = {{VX2750Pha::Fixed, "Fixed"},
...
static const std::map<std::string, VX2750Pha::Endpoint> stringToEndpoint = {
    {"raw", VX2750Pha::Raw}, {"dpppha", VX2750Pha::PHA}};
static const std::map<VX2750Pha::Endpoint, std::string> endpointToString = {
    {VX2750Pha::Raw, "raw"}, {VX2750Pha::PHA, "dpppha"}};
////////////////////////////////////////////////////////////////////////////////
// Public methods
 ...
 * @return std::string
 */
std::string VX2750Pha::getCupVersion() const {
 ...
 *  @return std::string
 */
std::string VX2750Pha::getFpgaFWVersion() const {
 ...
 * @return FWType
 */
VX2750Pha::FwType VX2750Pha::getFirmwareType() const {
 ...
 * @return std::string
 */
std::string VX2750Pha::getModelCode() const {
 ...
 */
std::string VX2750Pha::getPiggyBackCode() const {
 ...
 *
 */
std::string VX2750Pha::getModelName() const {
 ...
 */
VX2750Pha::FormFactor VX2750Pha::getFormFactor() const {
 ...
 */
int VX2750Pha::getFamilyCode() const { return GetDeviceInteger("FamilyCode"); }
/**
 * getSerialNumber
 *    @return std::string - serial string.
 */
std::string VX2750Pha::getSerialNumber() const {
 ...
 */
int VX2750Pha::getMotherboardRev() const {
 ...
 */
int VX2750Pha::getPiggybackRev() const { return GetDeviceInteger("PCBrev_PB"); }
/**
 *  getLicense
 *  @return std::string - license code.
 */
std::string VX2750Pha::getLicense() const { return GetDeviceValue("License"); }
/**
 * isLicensed
 * @return bool  True if this board is licensed.
 * @throw std::runtime_error - if the value is not recognized.
 */
bool VX2750Pha::isLicensed() const {
 ...
 */
int VX2750Pha::remainingUnlicensedTime() const {
 ...
 */
int VX2750Pha::channelCount() const { return GetDeviceInteger("NumCh"); }
/**
 * bitsOfResolution
 *    @return int -number of bits of resolution th adc has.
 */
int VX2750Pha::bitsOfResolution() const { return GetDeviceInteger("ADC_Nbit"); }
/**
 * sampleRate
 *   @return int The ADC sample rate in MHz
 */
int VX2750Pha::sampleRate() const { return GetDeviceInteger("ADC_SamplRate"); }
/**
 * inputRange
 *    @return int   - Volts peak-to-peak of input range.
 */
int VX2750Pha::inputRange() const { return GetDeviceInteger("InputRange"); }
/**
 *  isDifferential
 ...
 *     unrecognizable.
 */
bool VX2750Pha::isDifferentialInput() const {
 ...
 */
int VX2750Pha::inputImpedance() const { return GetDeviceInteger("Zin"); }

/**
 * ipAddress
 *   @return int  - uint32_t actually with IP address.
 */
int VX2750Pha::ipAddress() const {
 ...
 */
VX2750Pha::ClockSource VX2750Pha::getClockSource() const {
 ...
 */
void VX2750Pha::setClockSource(ClockSource selection) const {
  std::string src = enumToString(clockSourceToString, selection);
  SetDeviceValue("ClockSource", src.c_str());
}
/**
 * isClockOutOnP0
 *    @return bool - true if the clock output is enabled on the backplane P0
 * connector.
 */
bool VX2750Pha::isClockOutOnP0() const { return GetDeviceBool("EnClockOutP0"); }
/**
 * setClockOutOnP0
 *    Enable/disable the clock to be output on the P0 connector.
 *  @param bool - Desired state, true to enable.
 */
void VX2750Pha::setClockOutOnP0(bool state) const {
 ...
 *                   panel.
 */
bool VX2750Pha::isClockOutOnFP() const { return GetDeviceBool("EnClockOutFP"); }
/**
 * setCLockoutOnFP
 *     Enable/disable the clock to be output to the front panel.
 * @param bool  - desired state - true means output false don't.
 */
void VX2750Pha::setClockOutOnFP(bool state) const {

  SetDeviceValue("EnClockOutFP", state);
}
/**
 * getStartSource
 *   @return std::vector<VX2750Pha::StartSource> - describes the sources
 * selected to start digitizer runs.
 */
std::vector<VX2750Pha::StartSource> VX2750Pha::getStartSource() const {
...
/**
 * setStartSource
 *    @param src - std::Vector<VX2750Pha::StartSource> that selects what will
 * start data acquisition on a digitizer.
 */
void VX2750Pha::setStartSource(const std::vector<StartSource> &src) const {
  if (src.size() == 0) {
 ...
 */
void VX2750Pha::setGlobalTriggerSource(
    const std::vector<GlobalTriggerSource> &sel) const {
  if (sel.size() == 0) {
    throw std::logic_error(
        "setGlobalTriggerSource, requires at least one trigger source");
  }
 ...
 *     @return vector<VX2750Pha::WaveTriggerSource> - the wave trigger sources
 * of ch.
 */
 ...
 *    @param selection - vector WaveTriggerSource  to set as thee selected
 * value. the or of all of the triggers sources in the vector is the actual
 * trigger condition.
 *    @note - no attempt is made to remove duplicates.
 *    @note - At least one element must be in the selection.
 */
void VX2750Pha::setWaveTriggerSource(
    unsigned ch, const std::vector<WaveTriggerSource> &selection) const {
  if (selection.size() == 0) {
 ...
 *    @return std::vector<VX2750Pha::EventTriggerSource> - sources of ch's event
 * trigger.
 */
 ...
 *    @param ch - a digitizer channel number.
 *    @param selection - the VX2750Pha::EventTriggerSources selected for that
 * channel. The actual trigger source is the or of the sources in the vector. At
 * least one trigger source must be present.
 */
void VX2750Pha::setEventTriggerSource(
    unsigned ch, const std::vector<EventTriggerSource> &selection) const {
 ...
 */
std::uint64_t VX2750Pha::getChannelTriggerMask(unsigned ch) const {
 ...
 */
void VX2750Pha::setChannelTriggerMask(unsigned ch, std::uint64_t mask) const {
  std::stringstream s;
  s << mask;
...
/** getTraceRecordMode
 *    @param ch - digitizer channel.
 *    @return VX2750Pha::TraceRecordMode - the trace record mode for that
 * channel.
 */
VX2750Pha::TraceRecordMode VX2750Pha::getTraceRecordMode(unsigned chan) const {
 ...
 */
void VX2750Pha::setTraceRecordMode(unsigned ch, TraceRecordMode mode) const {
 ...
 * @return TRGOUTMode
 */
VX2750Pha::TRGOUTMode VX2750Pha::getTRGOUTMode() const {
 ...
 */
void VX2750Pha::setTRGOUTMode(TRGOUTMode select) const {
  std::string strMode = enumToString(TRGOUTToString, select);
  SetDeviceValue("TrgOutMode", strMode.c_str());
}
/**
 * getGPIOMode
 *    @return VX2750Pha::GPIOMode - value indicating what is signaled on the
 * GPIO output.
 */
VX2750Pha::GPIOMode VX2750Pha::getGPIOMode() const {
 ...
 */
void VX2750Pha::setGPIOMode(GPIOMode mode) const {
 ...
 */
VX2750Pha::BusyInSource VX2750Pha::getBusyInputSource() const {
 ...
 */
void VX2750Pha::setBusyInputSource(VX2750Pha::BusyInSource src) const {
  std::string value = enumToString(busyInToString, src);
  SetDeviceValue("BusyInSource", value.c_str());
}
/**
 *  getSyncOutMode
 *     @return VX2750Pha::SyncOutMode - the current selection of the CLKOUT
 * connector
 */
VX2750Pha::SyncOutMode VX2750Pha::getSyncOutMode() const {
 ...
 */
void VX2750Pha::setSyncOutMode(SyncOutMode mode) const {
 ...
 */
VX2750Pha::VetoSource VX2750Pha::getBoardVetoSource() const {
 ...
 */
void VX2750Pha::setBoardVetoSource(VetoSource src) const {
 ...
 */
std::uint64_t VX2750Pha::getBoardVetoWidth() const {
 ...
 */
void VX2750Pha::setBoardVetoWidth(std::uint64_t ns) const {
 ...
 */
VX2750Pha::VetoPolarity VX2750Pha::getBoardVetoPolarity() const {
 ...
 */
void VX2750Pha::setBoardVetoPolarity(VetoPolarity pol) const {
 ...
 */
void VX2750Pha::setChannelVetoSource(unsigned ch, ChannelVetoSource src) const {
 ...
 */
std::uint32_t VX2750Pha::getChannelVetoWidth(unsigned chan) const {
...
void VX2750Pha::setChannelVetoWidth(unsigned chan, std::uint32_t ns) const {
 ...
 */
std::uint32_t VX2750Pha::getRunDelay() const {
 ...
 */
void VX2750Pha::setRunDelay(std::uint32_t ns) const {
  SetDeviceValue("RunDelay", static_cast<int>(ns));
}
/**
 * isAutoDisarmEnabled
 *    @return bool - If true, the digitizer is set to disarm at the end of
 *                   a run.  If false, the digitizer remains armed when the run
 * end.
 */

bool VX2750Pha::isAutoDisarmEnabled() const {
 ...
 */
void VX2750Pha::setAutoDisarmEnabled(bool state) const {
 ...
 */
bool VX2750Pha::isMultiWindowRunEnabled() const {
 ...
 */
void VX2750Pha::setMultiWindowRunEnable(bool state) const {
 ...
 */
bool VX2750Pha::isPauseTimestampHoldEnabled() const {
  ...
  if (value == "Hold") {
    ...
    strError << "isTimestampHoldEnabled got an unrecognized value: '" << value
             << "'";
 ...
 */
void VX2750Pha::setPauseTimestampHold(bool enable) const {
 ...
 * @return std::uint32
 */
std::uint32_t VX2750Pha::getLEDStatus() const {
 ...
 */
std::uint32_t VX2750Pha::getAcquisitionStatus() const {
 ...
 */
std::uint32_t VX2750Pha::getMaxRawDataSize() const {
 ...
 * @return double
 */
double VX2750Pha::getVolatileClockDelay() const {
 ...
 */
void VX2750Pha::setVolatileClockDelay(double ps) const {
 ...
 *                         up.
 */
double VX2750Pha::getPermanentClockDelay() const {
 ...
 *                        delay.
 */
void VX2750Pha::setPermanentClockDelay(double ps) const {
 ...
 *              for that channel.
 */
VX2750Pha::WaveDataSource VX2750Pha::getWaveDataSource(unsigned ch) const {
  return stringToEnum(stringToWaveDataSource,
                      GetChanValue(ch, "WaveDataSource"));
}
/**
 * setWaveDataSource
 ...
 */
void VX2750Pha::setWaveDataSource(unsigned chan,
                                  WaveDataSource selection) const {
 ...
 */
std::uint32_t VX2750Pha::getRecordSamples(unsigned ch) const {
 ...
 */
void VX2750Pha::setRecordSamples(unsigned ch, std::uint32_t samples) const {
  SetChanValue(ch, "ChRecordLengthS", static_cast<int>(samples));
}
/**
 * getRecordNs
 *   @param ch - channel number.
 *   @return std::uint32_t - number of nanoseconds of waveform that will be
 * recorded.
 */
std::uint32_t VX2750Pha::getRecordNs(unsigned ch) const {
 ...
 */
void VX2750Pha::setRecordNs(unsigned ch, std::uint32_t ns) const {
 ...
 */
VX2750Pha::WaveResolution VX2750Pha::getWaveResolution(unsigned ch) const {
 ...
 *    @param sel - selector.
 */
void VX2750Pha::setWaveResolution(unsigned ch, WaveResolution sel) const {
 ...
 */
VX2750Pha::AnalogProbe VX2750Pha::getAnalogProbe(unsigned ch,
                                                 unsigned probeNum) const {
 ...
 */
void VX2750Pha::setAnalogProbe(unsigned ch, unsigned probeNum,
                               AnalogProbe selection) const {
 ...
 */
VX2750Pha::DigitalProbe VX2750Pha::getDigitalProbe(unsigned ch,
 ...
 */
void VX2750Pha::setDigitalProbe(unsigned ch, unsigned probe,
                                DigitalProbe selection) const {
  checkInclusiveRange(0, 3, probe);
  std::string param = appendNumber("WaveDigitalProbe", probe);
 ...
 *    @return std::uint32_t nsamples -samples in the pretrigger for that
 * channel.
 */
std::uint32_t VX2750Pha::getPreTriggerSamples(unsigned chan) const {
  return GetChanInteger(chan, "ChPreTriggerS");
}
/**
 * setPreTriggerSamples
 *    @param ch - channel number.
 *    @param samples - number of samples to have in the channels' pretrigger
 * window.
 */
void VX2750Pha::setPreTriggerSamples(unsigned ch, std::uint32_t samples) const {
 ...
 */
std::uint32_t VX2750Pha::getPreTriggerNs(unsigned chan) const {
 ...
 */
void VX2750Pha::setPreTriggerNs(unsigned chan, std::uint32_t ns) const {
 ...
 */
std::uint64_t VX2750Pha::getTestPulsePeriod() const {
 ...
 */
void VX2750Pha::setTestPulsePeriod(std::uint64_t ns) const {
 ...
 */
std::uint64_t VX2750Pha::getTestPulseWidth() const {
 ...
 */
void VX2750Pha::setTestPulseWidth(std::uint64_t ns) const {
 ...
 */
std::uint32_t VX2750Pha::getTestPulseLowLevel() const {
 ...
 */
void VX2750Pha::setTestPulseLowLevel(std::uint32_t counts) const {
 ...
 */
std::uint32_t VX2750Pha::getTestPulseHighLevel() const {
 ...
 */
void VX2750Pha::setTestPulseHighLevel(std::uint32_t counts) const {
  SetDeviceValue("TestPulseHighLevel", static_cast<int>(counts));
}
/**
 * getIOLevel
 *   @return VX2750Pha::IOLevel - I/O signalling level for the TRGIN, SIN,
 * TRGOUT I/Os.
 */
VX2750Pha::IOLevel VX2750Pha::getIOLevel() const {
 ...
 */
void VX2750Pha::setIOLevel(IOLevel level) const {
 ...
 */
double VX2750Pha::getAirInTemp() const {
 ...
 * @return double
 */
double VX2750Pha::getAirOutTemp() const {
 ...
 * @return double
 */
double VX2750Pha::getCoreTemp() const { return GetDeviceReal("TempSensCore"); }
/**
 * getFirstADCTemp
 *   @return double the temp in C at the first ADC sensor.
 */
double VX2750Pha::getFirstADCTemp() const {
 ...
 */
double VX2750Pha::getLastADCTemp() const {
 ...
 */
double VX2750Pha::getHottestADCTemp() const {
 ...
 */
double VX2750Pha::getADCTemp(unsigned chip) const {
 ...
 */
double VX2750Pha::getDCDCConverterTemp() const {
 ...
 */
double VX2750Pha::getDCDCConverterInputVoltage() const {
 ...
 */
double VX2750Pha::getDCDCConverterOutputVoltage() const {
 ...
 */
double VX2750Pha::getDCDCConverterAmps() const {
 ...
 */
double VX2750Pha::getDCDCConverterHz() const {
 ...
 */
double VX2750Pha::getDCDCConverterDutyCycle() const {
 ...
 */
std::uint32_t VX2750Pha::getFanSpeed(unsigned fan) const {
  checkInclusiveRange(0, 1, fan);
  std::string paramName =
      appendNumber("SpeedSensFan", fan + 1); // called 1/2 by CAEN.
 ...
 */
std::uint32_t VX2750Pha::getErrorFlagMask() const {
 ...
 */
void VX2750Pha::setErrorFlagMask(std::uint32_t mask) const {
 ...
 *               in the data.
 */
std::uint32_t VX2750Pha::getErrorFlagDataMask() const {
 ...
 */
void VX2750Pha::setErrorFlagDataMask(std::uint32_t mask) const {
 ...
 */
std::uint32_t VX2750Pha::getErrorFlags() const {
 ...
 */
bool VX2750Pha::isBoardReady() const {
 ...
 */
VX2750Pha::IndividualTriggerLogic VX2750Pha::getITLAMainLogic() const {
  std::string value = GetDeviceValue("ITLAMainLogic");
  return stringToEnum(stringToIndividualTriggerLogic, value);
}
/*v*
 * getITLBMainLogic.
 *   @return VX2750Pha::IndividualTriggerLogic - same as above but for trigger
 * B.
 */
VX2750Pha::IndividualTriggerLogic VX2750Pha::getITLBMainLogic() const {
 ...
 */
void VX2750Pha::setITLAMainLogic(IndividualTriggerLogic selection) const {
 ...
 * @param selection - The desired logic selection.
 */
void VX2750Pha::setITLBMainLogic(IndividualTriggerLogic selection) const {
  std::string value = enumToString(individualTriggerLogicToString, selection);
 ...
 */
unsigned VX2750Pha::getITLAMajorityLevel() const {
 ...
 */
unsigned VX2750Pha::getITLBMajorityLevel() const {
  return GetDeviceInteger("ITLBMajorityLev");
}
/**
 * setITLAMajoritylevel
 *   @param level - the number of channels that must be triggering in
 * coincidence to make ITLA trigger fire if it is in majority mode.
 */
void VX2750Pha::setITLAMajorityLevel(unsigned level) const {
 ...
 */
void VX2750Pha::setITLBMajorityLevel(unsigned level) const {
 ...
 */
VX2750Pha::PairTriggerLogic VX2750Pha::getITLAPairLogic() const {
 ...
 */
VX2750Pha::PairTriggerLogic VX2750Pha::getITLBPairLogic() const {
 ...
 */
void VX2750Pha::setITLAPairLogic(PairTriggerLogic sel) const {
 ...
 */
void VX2750Pha::setITLBPairLogic(PairTriggerLogic sel) const {
  std::string value = enumToString(pairLogicToString, sel);
 ...
 */
bool VX2750Pha::isITLAInverted() const {
...
bool VX2750Pha::isITLBInverted() const {
 ...
 */
void VX2750Pha::setITLAInverted(bool inverted) const {
 ...
 */
void VX2750Pha::setITLBInverted(bool inverted) const {
  std::string value = inverted ? "Inverted" : "Direct";
 ...
 *    @return ITLConnect
 */
VX2750Pha::ITLConnect VX2750Pha::getITLConnect(unsigned ch) const {
 ...
 */
void VX2750Pha::setITLConnect(unsigned ch, ITLConnect selection) const {
 ...
 *    @return uint64_t
 */
std::uint64_t VX2750Pha::getITLAMask() const {
 ...
 */
std::uint64_t VX2750Pha::getITLBMask() const {
 ...
 */
void VX2750Pha::setITLAMask(std::uint64_t mask) const {
 ...
 */
void VX2750Pha::setITLBMask(std::uint64_t mask) const {
 ...
 */
std::uint32_t VX2750Pha::getITLAGateWidth() const {
 ...
 */
std::uint32_t VX2750Pha::getITLBGateWidth() const {
 ...
 */
void VX2750Pha::setITLAGateWidth(std::uint32_t width) const {
 ...
 */
void VX2750Pha::setITLBGateWidth(std::uint32_t width) const {
 ...
 */
VX2750Pha::LVDSMode VX2750Pha::getLVDSMode(unsigned quartet) const {
 ...
 */
void VX2750Pha::setLVDSMode(unsigned quartet, LVDSMode mode) const {
 ...
 */
VX2750Pha::LVDSDirection VX2750Pha::getLVDSDirection(unsigned quartet) const {
  return stringToEnum(stringToLVDSDirection,
                      GetLVDSValue(quartet, "LVDSDirection"));
}
/**
 * setLVDSDirection
 ...
 */
void VX2750Pha::setLVDSDirection(unsigned quartet,
                                 LVDSDirection direction) const {
 ...
 */
std::uint16_t VX2750Pha::getLVDSIOReg() const {
 ...
 */
void VX2750Pha::setLVDSIOReg(std::uint16_t mask) const {
 ...
 * @return std::uint64_t
 */
std::uint64_t VX2750Pha::getLVDSTriggerMask(unsigned masknum) const {
 ...
 */
void VX2750Pha::setLVDSTriggerMask(unsigned masknum, std::uint64_t mask) const {
 ...
 */
VX2750Pha::DACOutputMode VX2750Pha::getDACOutMode() const {
 ...
 */
void VX2750Pha::setDACOutMode(DACOutputMode mode) const {
 ...
 * @return std::uint16_t
 */
std::uint16_t VX2750Pha::getDACOutValue() const {
 ...
 */
void VX2750Pha::setDACOutValue(std::uint16_t value) const {
 ...
 */
unsigned VX2750Pha::getDACChannel() const {
 ...
 */
void VX2750Pha::setDACChannel(unsigned chan) const {
 ...
 */
double VX2750Pha::getVGAGain(unsigned group) const {
 ...
 */
void VX2750Pha::setVGAGain(unsigned group, double value) const {
  std::stringstream strParName;
  strParName << "/vga/" << group << "/par/VGAGain";
  std::string parname = strParName.str();
 ...
 *                    is enabled.
 */
bool VX2750Pha::isOffsetCalibrationEnabled() const {
 ...
 */
void VX2750Pha::enableOffsetCalibration(bool enable) const {
 ...
 */
bool VX2750Pha::isChannelEnabled(unsigned chan) const {
 ...
 *   @param enable - true to enable false to disable.
 */
void VX2750Pha::enableChannel(unsigned chan, bool enable) const {
 ...
 */
int VX2750Pha::getSelfTriggerRate(unsigned chan) const {
 ...
 *                           bit names.
 */
std::uint32_t VX2750Pha::getChannelStatus(unsigned chan) const {
 ...
 */
double VX2750Pha::getDCOffset(unsigned chan) const {
 ...
 */
void VX2750Pha::setDCOffset(unsigned chan, double pct) const {
 ...
 */
double VX2750Pha::getGainFactor(unsigned chan) const {
 ...
 */
std::uint32_t VX2750Pha::getTriggerThreshold(unsigned chan) const {
 ...
 */
void VX2750Pha::setTriggerThreshold(unsigned chan,
 ...
 */
VX2750Pha::Polarity VX2750Pha::getPulsePolarity(unsigned chan) const {
 ...
 */
void VX2750Pha::setPulsePolarity(unsigned chan, Polarity pol) const {
 ...
 *   @return std::uint16_t
 */
std::uint16_t VX2750Pha::getEnergySkimLowDiscriminator(unsigned chan) const {
 ...
 */
void VX2750Pha::setEnergySkimLowDiscriminator(unsigned chan,
 ...
 */
std::uint16_t VX2750Pha::getEnergySkimHighDiscriminator(unsigned chan) const {
 ...
 */
void VX2750Pha::setEnergySkimHighDiscriminator(unsigned chan,
                                               std::uint16_t value) const {
 ...
 * getEventSelector
 *    @param chan - channel number.
 *    @return EventSelection - describes which events are actually saved by the
 * channel.
 */
VX2750Pha::EventSelection VX2750Pha::getEventSelector(unsigned chan) const {
  return stringToEnum(stringToEventSelection,
                      GetChanValue(chan, "EventSelector"));
}
/**
 * setEventSelector
 *    @param chan - channel number
 ...
 */
void VX2750Pha::setEventSelector(unsigned chan, EventSelection sel) const {
 ...
 */
VX2750Pha::EventSelection VX2750Pha::getWaveformSelector(unsigned chan) const {
  return stringToEnum(stringToEventSelection,
                      GetChanValue(chan, "WaveSelector"));
}
/**
 * setWaveSelector
 ...
 */
void VX2750Pha::setWaveformSelector(unsigned chan, EventSelection sel) const {
  std::string value = enumToString(eventSelectionToString, sel);
 ...
 */
VX2750Pha::CoincidenceMask VX2750Pha::getCoincidenceMask(unsigned chan) const {
  return stringToEnum(stringToCoincidenceMask,
                      GetChanValue(chan, "CoincidenceMask"));
}
/**
 * setCoincidenceMask
 *    @param chan -  channel to set.
 ...
 */
void VX2750Pha::setCoincidenceMask(unsigned chan, CoincidenceMask sel) const {
...
VX2750Pha::getAntiCoincidenceMask(unsigned chan) const {
  return stringToEnum(stringToCoincidenceMask,
                      GetChanValue(chan, "AntiCoincidenceMask"));
}
/**
 ...
 */
void VX2750Pha::setAntiCoincidenceMask(unsigned chan,
                                       CoincidenceMask sel) const {
  std::string value = enumToString(coincidenceMaskToString, sel);
 ...
 *    @param chan - channel to fetch from.
 *    @return std::uint32_t - number of samples in the coincidence trigger
 * window.
 */
std::uint32_t VX2750Pha::getCoincidenceSamples(unsigned chan) const {
  return GetChanInteger(chan, "CoincidenceLengthS");
}
/**
 * setCoincidenceSamples
 *    @param chan - channel to set.
 *    @param samples -# samples to be used for that channel's coincidence
 * window.
 */
void VX2750Pha::setCoincidenceSamples(unsigned chan,
 ...
 */
std::uint32_t VX2750Pha::getCoincidenceNs(unsigned chan) const {
 ...
 */
void VX2750Pha::setCoincidenceNs(unsigned chan, std::uint32_t ns) const {
 ...
 */
std::uint32_t VX2750Pha::getTimeFilterRiseTime(unsigned chan) const {
 ...
 */
std::uint32_t VX2750Pha::getTimeFilterRiseSamples(unsigned chan) const {
 ...
 */
void VX2750Pha::setTimeFilterRiseTime(unsigned chan, std::uint32_t ns) const {
 ...
 */
void VX2750Pha::setTimeFilterRiseSamples(unsigned chan,
                                         std::uint32_t samples) const {
 ...
 */
std::uint32_t VX2750Pha::getTimeFilterRetriggerGuardTime(unsigned chan) const {
 ...
 */
void VX2750Pha::setTimeFilterRetriggerGuardTime(unsigned chan,
 ...
 */
void VX2750Pha::setTimeFilterRetriggerGuardSamples(
    unsigned chan, std::uint32_t samples) const {
 ...
 */
std::uint32_t VX2750Pha::getEnergyFilterRiseTime(unsigned chan) const {
 ...
 */
std::uint32_t VX2750Pha::getEnergyFilterRiseSamples(unsigned chan) const {
 ...
 */
void VX2750Pha::setEnergyFilterRiseTime(unsigned chan, std::uint32_t ns) const {
 ...
 */
void VX2750Pha::setEnergyFilterRiseSamples(unsigned chan,
                                           std::uint32_t samples) const {
 ...
 */
std::uint32_t VX2750Pha::getEnergyFilterFlatTopTime(unsigned ch) const {
 ...
 */
std::uint32_t VX2750Pha::getEnergyFilterFlatTopSamples(unsigned ch) const {
 ...
 */
void VX2750Pha::setEnergyFilterFlatTopTime(unsigned ch,
                                           std::uint32_t ns) const {
 ...
 */
void VX2750Pha::setEnergyFilterFlatTopSamples(unsigned ch,
                                              std::uint32_t samples) const {
 ...
 *    @param ch - channel number.
 *    @return std::uint32_t - The trapezoid Peaking Position in percentage (%)
 * of the flat top.
 */
std::uint32_t VX2750Pha::getEnergyFilterPeakingPosition(unsigned chan) const {
  return GetChanInteger(chan, "EnergyFilterPeakingPosition");
}
/**
 * setEnergyFilterPeakingPosition.
 *   @param ch - channel number.
 *   @param pct - The trapezoid Peaking Position in percentage (%) of the flat
 * top.
 */
void VX2750Pha::setEnergyFilterPeakingPosition(unsigned ch,
                                               std::uint32_t pct) const {
...
VX2750Pha::getEnergyFilterPeakingAverage(unsigned ch) const {
  return stringToEnum(stringToPeakingAverage,
                      GetChanValue(ch, "EnergyFilterPeakingAvg"));
}
/**
 ...
 */
void VX2750Pha::setEnergyFilterPeakingAverage(
    unsigned ch, EnergyPeakingAverage selection) const {
 ...
 */
std::uint32_t VX2750Pha::getEnergyFilterPoleZeroTime(unsigned ch) const {
 ...
 */
std::uint32_t VX2750Pha::getEnergyFilterPoleZeroSamples(unsigned ch) const {
 ...
 */
void VX2750Pha::setEnergyFilterPoleZeroTime(unsigned chan,
                                            std::uint32_t ns) const {
 ...
 */
void VX2750Pha::setEnergyFilterPoleZeroSamples(unsigned ch,
                                               std::uint32_t samples) const {
 ...
 */
double VX2750Pha::getEnergyFilterFineGain(unsigned ch) const {
 ...
 */
void VX2750Pha::setEnergyFilterFineGain(unsigned ch, double value) const {
 ...
 */
bool VX2750Pha::isEnergyFilterFLimitationEnabled(unsigned chan) const {
 ...
 */
void VX2750Pha::enableEnergyFilterFLimitation(unsigned chan,
                                              bool enable) const {
  SetChanValue(chan, "EnergyFilterLFLimitation", enable ? "On" : "Off");
}
/** getEnergyFilterBaselineAverage
 *      Returns an enum value that indicates the number of samples that are
 * averaged to compute the running baseline.
 *   @param ch - channel
...
VX2750Pha::getEnergyFilterBaselineAverage(unsigned ch) const {
  return stringToEnum(stringToBLAverage,
                      GetChanValue(ch, "EnergyFilterBaselineAvg"));
}
/**
 ...
 */
void VX2750Pha::setEnergyFilterBaselineAverage(
    unsigned chan, EnergyFilterBaselineAverage sel) const {
 ...
 */
std::uint32_t VX2750Pha::getEnergyFilterBaselineGuardTime(unsigned ch) const {
 ...
 */
void VX2750Pha::setEnergyFilterBaselineGuardTime(unsigned ch,
                                                 std::uint32_t ns) const {
 ...
 */
void VX2750Pha::setEnergyFilterBaselineGuardSamples(
    unsigned ch, std::uint32_t samples) const {
 ...
 */
std::uint32_t VX2750Pha::getEnergyFilterPileupGuardTime(unsigned ch) const {
 ...
 *    Same as above but in units of samples.
 */
std::uint32_t VX2750Pha::getEnergyFilterPileupGuardSamples(unsigned ch) const {
 ...
 */
void VX2750Pha::setEnergyFilterPileupGuardTime(unsigned chan,
                                               std::uint32_t ns) const {
 ...
 */
void VX2750Pha::setEnergyFilterPileupGuardSamples(unsigned chan,
                                                  std::uint32_t samples) const {
 ...
 */
std::uint8_t VX2750Pha::getEnergyBits(unsigned ch) const {
 ...
 */
std::uint64_t VX2750Pha::getRealtime(unsigned ch) const {
 ...
 */
std::uint64_t VX2750Pha::getDeadtime(unsigned ch) const {
 ...
 */
void VX2750Pha::Reset() { Command("Reset"); }
/**
 * ClearData
 ...
 */
void VX2750Pha::Clear() { Command("ClearData"); }
/**
 * Arm
 ...
 */
void VX2750Pha::Arm() { Command("ArmAcquisition"); }
/*
 * Disarm:
 ...
 */
void VX2750Pha::Disarm() { Command("DisarmAcquisition"); }
/**
 * Start
 ...
 */
void VX2750Pha::selectEndpoint(Endpoint selection) {
 ...
 *   to default.
 */
void VX2750Pha::initializeRawEndpoint() {
 ...
 */
size_t VX2750Pha::readRawEndpoint(void *pBuffer) {
  size_t s;
  void *argv[2];
  argv[0] = &s;
  argv[1] = pBuffer;
 ...
 *     will be used.
 */
void VX2750Pha::setDefaultFormat() { m_dppPhaOptions.resetOptions(); }
/**
 * enableRawTimestamp
 ...
 */
void VX2750Pha::enableRawTimestamp(bool enable) {
 ...
 *         JSON and send it to the device.
 */
void VX2750Pha::enableFineTimestamp(bool enable) {
 ...
 *         JSON and send it to the device.
 */
void VX2750Pha::enableFlags(bool enable) {
 ...
 *         JSON and send it to the device.
 */
void VX2750Pha::enableDownsampling(bool enable) {
 ...
 *        read.
 */
void VX2750Pha::enableAnalogProbes(bool probe1, bool probe2) {
  m_dppPhaOptions.s_enableAnalogProbe1 = probe1;
  m_dppPhaOptions.s_enableAnalogProbe2 = probe2;
}
/**
 * enbaleDigitalProbes
 *   Up to four digital probes can be assigned and independently enabled for
 * readout. Note that enabling a probe also enables the corresponding probe
 *   description.
 *
 ...
 */
void VX2750Pha::enableDigitalProbes(bool probe1, bool probe2, bool probe3,
                                    bool probe4) {
 ...
 */
void VX2750Pha::enableSampleSize(bool enable) {
 ...
 *  @param enable - true to enable. false to disable.
 */
void VX2750Pha::enableRawEventSize(bool enable) {
 ...
 */
void VX2750Pha::initializeDPPPHAReadout() {
  unsigned index(0);
  Json::Value description;
 ...
 *   @note - blocks until reads are satisified.  This means that you'd better
 ...
 *        of the desired data.
 */
void VX2750Pha::readDPPPHAEndpoint(DecodedEvent &event) {
  void *argv[DPP_MAX_PARAMS]; // Some extra slots...but beware if DecodedEvents
                              // expands.
  int argc = 0;
  ...
  argv[argc++] = &(event.s_fail); // Issue 356: add fail bit to event data
 ...
 */
void VX2750Pha::initDecodedBuffer(DecodedEvent &event) {
 ...
 */
void VX2750Pha::setupDecodedBuffer(DecodedEvent &event) {
  ...
  if (samples % sizeof(std::uint8_t) > 0)
    dProbeLen++; // Partial byte.
 ...
 *
 */
void VX2750Pha::freeDecodedBuffer(DecodedEvent &event) {
 ...
 */
uint32_t VX2750Pha::dottedToInt(const std::string &dotted) const {
  int result = 0;
 ...
 */
bool VX2750Pha::textToBool(const std::string &str) const {
 ...
 */
void VX2750Pha::checkInclusiveRange(int low, int high, int value) const {
  if ((value < low) || (value > high)) {
    std::stringstream strMessage;
    strMessage << "The value " << value << " is not in the range [" << low
               << ',' << high << ']';
 ...
 * @return std::string
 */
std::string VX2750Pha::appendNumber(const char *base, unsigned value) const {
  // stupid slow way:
 ...
 *
 */
Json::Value VX2750Pha::createScalar(const char *name, const char *type) const {
  Json::Value result;
 ...
 * @return Json::Value
 */
Json::Value VX2750Pha::createArray(const char *name, const char *type,
 ...
 */
std::string VX2750Pha::toUpper(const std::string &s) {
  std::string result;
 ...
 */
std::vector<std::string> VX2750Pha::orListToStringList(std::string orlist) {
  // Strip the whitespace with thanks to
  // https://www.techiedelight.com/remove-whitespaces-string-cpp/

  orlist.erase(std::remove_if(orlist.begin(), orlist.end(), ::isspace),
               orlist.end());

...
/*!
   ...
   \param CVMUSB&controller   References a VMSUB controller that will be used
    ...
    @todo: See if the delays can be removed!
*/
...
CMADC32::Initialize(CVMUSB& controller)
{
  ...
  controller.vmeWrite16(base + Ipl, initamod, (uint16_t)0);
  ...
  controller.vmeWrite16(base + ModuleId, initamod, id); // Module id.
  controller.delay(MADCDELAY);
  ...
  for (int i =0; i < 32; i++) {
    controller.vmeWrite16(base + Thresholds + i*sizeof(uint16_t), initamod, (uint16_t)thresholds[i]);
    controller.delay(MADCDELAY);
  }
  ...
  // as well as enable it.
	...
	controller.vmeWrite16(base + HoldDelay0, initamod, (uint16_t)holddelays[0]);
	controller.delay(MADCDELAY);
	controller.vmeWrite16(base + HoldDelay1, initamod, (uint16_t)holddelays[1]);
	controller.delay(MADCDELAY);

	controller.vmeWrite16(base + HoldWidth0, initamod, (uint16_t)holdwidths[0]);
	controller.delay(MADCDELAY);
	controller.vmeWrite16(base + HoldWidth1, initamod, (uint16_t)holdwidths[1]);
	controller.delay(MADCDELAY);
	controller.vmeWrite16(base + EnableGDG, initamod, (uint16_t)gdg); // enable the appropriate gdgs.
	controller.delay(MADCDELAY);
  ...
  if (inputrange == string("4v")) {
    controller.vmeWrite16(base + InputRange, initamod,(uint16_t) 0);
  }
  else if (inputrange == string("8v")) {
    controller.vmeWrite16(base + InputRange, initamod, (uint16_t)2);
  }
  else {			// 10V
    controller.vmeWrite16(base + InputRange, initamod, (uint16_t)1);
  }
  controller.delay(MADCDELAY);
  ...
  controller.vmeWrite16(base + TimingDivisor, initamod, (uint16_t)timedivisor);
  controller.delay(MADCDELAY);
  ...
  if(termination) {
    controller.vmeWrite16(base + ECLTermination, initamod, (uint16_t)0xf);
  }
  else {
    controller.vmeWrite16(base + ECLTermination, initamod, (uint16_t)0);
  }
  controller.delay(MADCDELAY);
  ...
  if (ecltimeinput) {
    controller.vmeWrite16(base + ECLGate1OrTiming, initamod, (uint16_t)1);
    controller.delay(MADCDELAY);
    controller.vmeWrite16(base + ECLFCOrTimeReset, initamod, (uint16_t)1);
    controller.delay(MADCDELAY);
  }
  else {
    controller.vmeWrite16(base + ECLGate1OrTiming, initamod, (uint16_t)0);
    controller.delay(MADCDELAY);
    controller.vmeWrite16(base + ECLFCOrTimeReset, initamod, (uint16_t)0);
    controller.delay(MADCDELAY);
  }

  if (nimtimeinput) {
    controller.vmeWrite16(base + NIMGate1OrTiming, initamod, (uint16_t)1);
    controller.delay(MADCDELAY);
    controller.vmeWrite16(base + NIMFCOrTimeReset, initamod, (uint16_t)1);
    controller.delay(MADCDELAY);
  }
  else {
    controller.vmeWrite16(base + NIMGate1OrTiming, initamod, (uint16_t)0);
    controller.delay(MADCDELAY);
    controller.vmeWrite16(base + NIMFCOrTimeReset, initamod, (uint16_t)0);
    controller.delay(MADCDELAY);
  }
  ...
  if(timesource == string("vme") ) {
    controller.vmeWrite16(base + TimingSource, initamod, (uint16_t)0);
  }
  else {
    controller.vmeWrite16(base + TimingSource, initamod, (uint16_t)1);
  }
  controller.delay(MADCDELAY);
  controller.vmeWrite16(base + TimestampReset, initamod, (uint16_t)3); // Reset both counters.
  controller.delay(MADCDELAY);
  ...
  controller.vmeWrite16(base + NIMBusyFunction, initamod, (uint16_t)nimBusyRegValue);
  controller.delay(MADCDELAY);
  ...
  controller.vmeWrite16(base + Vector,   initamod, (uint16_t)ivector);
  controller.delay(MADCDELAY);
  controller.vmeWrite16(base + Ipl, initamod, (uint16_t)ipl);
  controller.vmeWrite16(base + IrqThreshold, initamod, (uint16_t)irqThreshold);
  controller.delay(MADCDELAY);
  ...
  controller.vmeWrite16(base + ReadoutReset, initamod, (uint16_t)1);
  controller.delay(MADCDELAY);
  controller.vmeWrite16(base + InitFifo,     initamod, (uint16_t)0);
  controller.delay(MADCDELAY);

  // The VMUSB does not like lists that end in a delay so:
  
  //  controller.vmeWrite16(base + StartAcq, initamod, (uint16_t)1 );

 ...
 */
void CMQDC32RdoHdwr::configureModuleID(CVMUSB& list) {
 ...
 * \param list a readout list
 */
void CMQDC32RdoHdwr::configureThresholds(CVMUSB& list) {
 ...
 * \param list a readout list
 */
void CMQDC32RdoHdwr::configureMarkerType(CVMUSB& list) {
 ...
 * \param list  a readout list
 */
void CMQDC32RdoHdwr::configureMemoryBankSeparation(CVMUSB& list) {
 ...
 * \param list  a readout list
 */
void CMQDC32RdoHdwr::configureGates(CVMUSB& list) {
 ...
 * \param list  a readout list
 */
void CMQDC32RdoHdwr::configureBankOffsets(CVMUSB& list) {
 ...
 *
 */
void CMQDC32RdoHdwr::configureTestPulser(CVMUSB& list) {
 ...
 *
 */
void CMQDC32RdoHdwr::configureInputCoupling(CVMUSB& list) {
 ...
 *
 */
void CMQDC32RdoHdwr::configureTimeDivisor(CVMUSB& list) {
 ...
 * \param list  a readout list
 */
void CMQDC32RdoHdwr::configureECLTermination(CVMUSB& list) {
 ...
 *  \param list   a readout list
 */
void CMQDC32RdoHdwr::configureECLInputs(CVMUSB& list) {
 ...
 *  \param list   a readout list
 */
void CMQDC32RdoHdwr::configureNIMInputs(CVMUSB& list) {
 ...
 *  \param list a readout list
 */
void CMQDC32RdoHdwr::configureNIMBusy(CVMUSB& list) {
 ...
 *
 */
void CMQDC32RdoHdwr::configureTimeBaseSource(CVMUSB& list) {
 ...
 * \param list    a readout list
 */
void CMQDC32RdoHdwr::configureIrq(CVMUSB& list) {
 ...
 * \param list    a readout list
 */
void CMQDC32RdoHdwr::configureMultiEventMode(CVMUSB& list) {
 ...
 * \param list  a readout list
 */
void CMQDC32RdoHdwr::configureMultiplicity(CVMUSB& list) {
 ...
 */
void
CMQDC32RdoHdwr::configureCounterReset(CVMUSB& list) 
{
...
CMQDC32RdoHdwr::onEndRun(CVMUSB& ctlr) {
  CVMUSB* pList = & ctlr;      // Since I'm lazy.

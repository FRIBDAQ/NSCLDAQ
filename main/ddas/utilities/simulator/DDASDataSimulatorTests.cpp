...
public:
  void setUp() { m_pSimulator = new DDASDataSimulator("dummyfile", 12); };
  void tearDown() { delete m_pSimulator; };
...
void SimulatorTests::idword_revh() {
  m_hit.Reset();
  m_unpacked.Reset();
...
void SimulatorTests::word0_revh() {
  m_hit.Reset();
  m_unpacked.Reset();
...
void SimulatorTests::word1and2_100() {
  m_hit.Reset();
  m_unpacked.Reset();
...
void SimulatorTests::word1and2_250() {
  m_hit.Reset();
  m_unpacked.Reset();
...
void SimulatorTests::word1and2_500() {
  m_hit.Reset();
  m_unpacked.Reset();
...
void SimulatorTests::energySums() {
  m_hit.Reset();
  m_unpacked.Reset();
...
void SimulatorTests::allOptions() {
  m_hit.Reset();
  m_unpacked.Reset();
  ...
  uint32_t hdrLen =
      SIZE_OF_RAW_EVENT + SIZE_OF_EXT_TS + SIZE_OF_ENE_SUMS + SIZE_OF_QDC_SUMS;

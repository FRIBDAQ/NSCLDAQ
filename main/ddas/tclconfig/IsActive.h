 ...
 * element which is the or of the status of all elements (e.g. a boolean
 * that is true if any module in the configuration is active an false if none
 * are). The remaining elements are three elements sublists that contain, in
 * order the following elements:

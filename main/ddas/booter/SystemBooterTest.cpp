...
// Tests will pull the next two in from ../xiatest
...
public:
  ...
  public:
    ...
    m_config.setFirmwareConfiguration(HR::RevB_100MHz_12Bit,
                                      {"bcd_0", "bcd_1", "bcd_2", "bcd_3"});
    m_config.setFirmwareConfiguration(HR::RevF_250MHz_14Bit,
                                      {"f250_0", "f250_1", "f250_2", "f250_3"});
    m_config.setFirmwareConfiguration(HR::RevF_500MHz_12Bit,
                                      {"f500_0", "f500_1", "f500_2", "f500_3"});
    ...
    void boot_0() {
    EQMSG("first module should be detected as revbcd",
          int(HR::RevB_100MHz_12Bit), m_config.getHardwareMap()[0]);
    }

    void boot_1() {
    EQMSG("2nd module should be detected as revf_250MHz_14Bit",
          int(HR::RevF_250MHz_14Bit), m_config.getHardwareMap()[1]);
    }

    void boot_2() {
    EQMSG("3rd module should be detected as revf_500MHz_12Bit",
          int(HR::RevF_500MHz_12Bit), m_config.getHardwareMap()[2]);
    }

    void boot_3() {
    EQMSG("all three modules should have boot records", size_t(3),
          m_activityLog.size());
    }

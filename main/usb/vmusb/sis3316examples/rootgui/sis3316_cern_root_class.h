...
#define GRAPH_MAX_DRAW_LENGTH  0x40000 // 256K
...
public:
	...
	void sis3316_set_max_Yaxis(unsigned int max_y) ;
	...
	void sis3316_draw_32bit_chN(unsigned int plot_length, unsigned int* ch_rawdata_buffer, unsigned int ch_no);
...
void sis3316_reset_histogram(int histogram_index);
